          ...
          <div className="mt-auto">
            <div className="rounded-xl p-4" style={{ background: 'rgba(88,101,242,0.08)', border: '0.5px solid rgba(88,101,242,0.2)' }}>
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-dm text-[12px] font-[500] text-white">{t('discord.title')}</span>
              </div>
              <p className="font-dm text-[11px] mb-3" style={{ color: 'rgba(255,255,255,0.3)' }}>{t('discord.description')}</p>
